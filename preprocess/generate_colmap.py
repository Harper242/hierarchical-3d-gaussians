...
if __name__ == '__main__':
    ...
    parser.add_argument('--project_dir', default="../dataset/CUS3D/inputs", type=str, required=False)
    parser.add_argument('--images_dir', default="../dataset/CUS3D/inputs/images", help="Will be set to project_dir/inputs/images if not set")
    parser.add_argument('--masks_dir', default="../dataset/CUS3D/inputs/masks", help="Will be set to project_dir/inputs/masks if exists and not set")
    ...
    make_colmap_custom_matcher_args = [
        "python", f"make_colmap_custom_matcher.py",
        "--image_path", f"{args.images_dir}",
