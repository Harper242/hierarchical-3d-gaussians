...
if __name__ == '__main__':
    ...
    parser.add_argument('--project_dir', default="../dataset/CUS3D/inputs", required=False, help="images, colmap and chunks paths doesnt have to be set if you generated the colmap using generate_colmap script.")
    parser.add_argument('--images_dir', default="../dataset/CUS3D/inputs/images")
    ...
    for chunk_name in chunk_names:
        ...
        if args.use_slurm:
            ...
            job = submit_job(slurm_args + [
                ...
                "prepare_chunk.slurm", in_dir, out_dir,images_dir,
